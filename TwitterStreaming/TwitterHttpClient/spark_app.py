...
def aggregate_tags_count(new_values, total_sum):
    ...
    # return (sum(new_values[0]) + total_sum[0] or 0, sum(new_values[1]) + total_sum[1] or 0, sum(new_values[2]) + total_sum[2] or 0, sum(new_values[3]) + total_sum[3] or 0)
